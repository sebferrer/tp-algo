...
public class Exercice6 {
    ...
    public static void main(String[] args) {
        ...
        switch (destination) {
            case 'p': // Destination proche

                tarifTotalIndividuel = nbAdultes * TARIF_ADULTE_INDIVIDUEL_PROCHE +
                        nbEnfants * TARIF_ENFANT_INDIVIDUEL_PROCHE;

                if (nbTotalVoyageurs < 10) {
                    meilleurTarif = tarifTotalIndividuel;
                } else {
                    tarifTotalGroupe = nbTotalVoyageurs * TARIF_GROUPE_PROCHE;

                    if (tarifTotalGroupe < tarifTotalIndividuel) {
                        meilleurTarif = tarifTotalGroupe;
                        groupe = true;
                    } else {
                        meilleurTarif = tarifTotalIndividuel;
                    }
                ...
                break;
            case 'e': // Destination Eloignée

                tarifTotalIndividuel = nbAdultes * TARIF_ADULTE_INDIVIDUEL_ELOIGNE +
                        nbEnfants * TARIF_ENFANT_INDIVIDUEL_ELOIGNE;

                if (nbTotalVoyageurs < 10) {
                    meilleurTarif = tarifTotalIndividuel;
                } else {
                    tarifTotalGroupe = nbTotalVoyageurs * TARIF_GROUPE_ELOIGNE;
